...
|   > Last updated: 24 Feb, 2009 13:15:07
+--------------------------------------------------------------------------
*/
...
$LANG[FirstPage]='FisrtPage';
$LANG[LastPage]='LastPage';
$LANG[Pages]='Pages';
$LANG[PreviousPage]='Previous';
$LANG[NextPage]='Next';
$LANG[YES]='Yes';
$LANG[NO]='No';
...
# Menu titles
###############################
$LANG[SEC_MENUTITLES]='Menu titles';
$LANG[Slogan]='The best file hosting service!';
$LANG[Bookmark]='Add bookmark';
$LANG[SetHome]='Set as homepage';
$LANG[MHome]='Home';
$LANG[MContact]='Contact Us';
$LANG[MRegister]='Register';
$LANG[MLogin]='Login';
$LANG[MAccount]='Account area';
$LANG[MLogout]='Logout';
$LANG[MService]='Service';
$LANG[MTOS]='TOS';
$LANG[MSitenews]='Site News';
$LANG[MReport]='Report abuse';
$LANG[MFAQ]='FAQ';
$LANG[MLinktoUs]='Link to us';

###############################
# Page titles
###############################
$LANG[SEC_PAGETITLES]='Page titles';
$LANG[SITEDOWNLOAD]='%s';
$LANG[SITEREGISTER]='Register';
$LANG[SITEREPORT]='Report';
$LANG[SITELOGIN]='Login';
$LANG[SITECONTACTUS]='Contact us';
$LANG[SITESERVICES]='Services';
$LANG[SITEMEMBERS]='Member area';
$LANG[SITETOP]='Top 100';
$LANG[SITENEWS]='Sitenews';
$LANG[SITEFAQ]='Site FAQs';
$LANG[SITEDELETE]='Delete File';
$LANG[SITERULES]='Rules';
$LANG[SITETOPFILES]='Top Files';
$LANG[SITEFOLDERS]='%s';

###############################
# Upload interface
###############################
$LANG[SEC_UPLOADFORM]='Upload interface';
$LANG[UploadFormTitle]='Upload file!';
$LANG[FormUpload]='Form Upload';
$LANG[FormUploadHint]='Click "browser" to select a file from your PC to upload!';
$LANG[UrlUpload]='URL Upload';
$LANG[UrlUploadHint]='Enter your file URL,we will fetch it for you,Format:http://remote.com/file.ext';
$LANG[FtpUpload]='FTP Upload';
$LANG[FtpUploadHint]='Enter your ftp URL,we will fetch it for you,Format:anonymous ftp://domain.com/file.ext or ftp://username:password@domain.com/file.ext!';
$LANG[FlashUpload]='Flash Upload';
$LANG[FlashUploadHint]='Use Flash object upload files easily,Note:Flash 8 Player is required!';
$LANG[FlashUploadHelp1]='Please add files by using the';
$LANG[FlashUploadHelp2]=' icon in your lower right';
$LANG[FlashNotLoaded]='Wait a moment,flash object is not loaded!';
...
$LANG[EditTitle]='Edit';
$LANG[SaveTitle]='Save';
$LANG[UploadDisabled]='This type of upload is disabled currently!please <a href="register.php">register</a> to enable it!';
$LANG[SiteOffline]='Our site is currently under maintenance. We should be back shortly. Thank you for your patience.';
$LANG[UploadWait]='If you are interested in visiting one of the
                  sponsored links during your upload,<BR>please "right click" on
                  the advertisement to avoid interruption of your upload.';
$LANG[SelectFile]='Select file to send';
$LANG[HostIt]='Host It';
$LANG[FileDescr]='Meaningful file description (optional)';
$LANG[PW4File]='Password for download (optional)';
$LANG[SenderEmail]='Your email (optional)';
$LANG[ReciEmail]='Recipients (optional,one or multiple, less 1000, seperated by comma)';
$LANG[UDownLink]='Your Download-Link:';
$LANG[UDeleteLink]='Your Delete-Link:';
$LANG[Status]='Status';
$LANG[EstTimeLeft]='Est time left';
$LANG[ElapTime]='Elapsed time';
$LANG[IniUploadBar]='Initializing upload ...';
$LANG[IAccept]='I accept';
$LANG[TOS]='terms of service';
$LANG[YourFile]='Your file';
$LANG[FileUploaded]='have been uploaded successfully.';
$LANG[FeaturedFiles]='Uploading Top Files (a few examples below)';

###############################
# Member area
###############################
$LANG[SEC_MEMBERAREA]='Member area';
$LANG[Welcome]='Welcome';
$LANG[AccountMenu]='Account Menu';
$LANG[Sitenews]='Sitenews';
$LANG[Overview]='Overview';
$LANG[Profile]='My Profile';
$LANG[ShowLinks]='Show Files';
$LANG[Folder]='Folder';
$LANG[DownloadHistory]='Download History';
$LANG[PointsHistory]='Points History';
$LANG[RewardCenter]='Reward Center';
$LANG[Upgrade]='Upgrade';
$LANG[UpgradeInfo]='Your current plan is <b>%s</b>,expired at <b>%s</b><br>
Upgrade your host package easily.';
$LANG[Bill]='Bill History';
$LANG[ChangePass]='Change Password';
$LANG[NewPassWord]='New Password';
$LANG[MyPackageName]='Your Package';
$LANG[PackageExpireDate]='Package Expire Date';
$LANG[PackageExpired]='Expired?';
$LANG[NeverExpired]='Never';
$LANG[RegDate]='Register Date';
$LANG[HosedFiles]='Hosted Files';
$LANG[TotalDownloads]='Total Downloads';
$LANG[TotalPoints]='Total Points';
$LANG[UploadThumb]='Thumbnail';
$LANG[RecordID]='ID';
$LANG[TXNID]='TXN ID';
$LANG[BillDescr]='Descr';
$LANG[BillFee]='Fee';
$LANG[BillType]='Type';
$LANG[BillDate]='Date';
$LANG[PromotionUpgrade]='Promotion Upgrade';
$LANG[PromotionPayout]='Promotion Payout';
$LANG[TargetPackage]='Target Package';
$LANG[ExtendMonths]='Extend Months';
$LANG[ExchangeMoney]='Exchange Money';
$LANG[Points]='Points Fee';
$LANG[Note]='Payout Note';
$LANG[Unlimited]='Unlimited';
$LANG[PromotionName]='Promotion';
$LANG[HistoryPoints]='Points';
$LANG[HistorySize]='Size';
$LANG[HistoryDownloads]='Downloads';
$LANG[HistoryDate]='Date';
$LANG[HistoryStatus]='Status';
$LANG[PointType]='Type';
$LANG[UsedPoints]='Used Points';
$LANG[PointsConvertDone]='Points Converted Sucessfully!';
$LANG[ConfirmConvert]='Confirm Points Convert!';
$LANG[SpendPoints]='Spend Points';
$LANG[LessPointsWarning]='Points Warning';

###############################
# File listing page
###############################
$LANG[SEC_FILELISTING]='File listing page';
$LANG[FileName]='File name';
$LANG[FileSize]='File size';
$LANG[FileDate]='Date';
$LANG[FileDetails]='Details';
$LANG[FileDownloads]='Downloads';
$LANG[FileDescription]='Description';
$LANG[UploadTime]='Upload Date';
$LANG[Delete]='Delete';
$LANG[FileInTotal]='Files in Total';
$LANG[All]='All';
$LANG[ConfirmDeleteFile]='Are you sure delete this file?';
$LANG[ClickEditDescr]='Click here to edit this description';
$LANG[ClickEditPW]='Click here to edit this password';
$LANG[Permit]='Permit';
