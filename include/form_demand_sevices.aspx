...
<form name=\"check_demand\" id=\"check_demand\" method=\"post\" action=\"http://wm-rb.net/check_demand.aspx\" onSubmit=\"return Check()\">
                    <table width=\"350\" border=\"0\" cellspacing=\"1\" cellpadding=\"10\" bgColor=\"#ebebeb\">
                      ...
                      <tr class=\"text\" bgColor=\"#ffffff\">
                        <td align=\"right\">Отдаете, {$currency}:&nbsp;</td>
                        <td align=\"center\">
...
switch ($_POST['type_usluga']) :
	...
	case ("output_NAL") : $Constructor->check($oplata,"",$_COOKIE['purse_'.$oplata],"");
	echo "<input type=\"hidden\" name=\"operation_type\" value=\"4\">"; break;
	...
	endswitch;
			...
			<div class=\"text\">C <a href=\"http://wm-rb.net/rules.aspx\" target=\"_blank\" title=\"Правила предоставления услуг\">правилами</a> предоставления услуг согласен <input type=\"checkbox\" name=\"rules\"></div></td>
                    ...
                    <input type=\"submit\" name=\"{$Cons_uslugi->name_submit($type_usluga)}\" id=\"{$Cons_uslugi->name_submit($type_usluga)}\" value=\"Продолжить\" style=\"width:100px;
