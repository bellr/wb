...
$DBName_forum = "wmrb_forumBB";
$DBUser_forum = "forumBB";
$DBPassword_forum = "Dbnfkbq_1986";
...
//йкюяя дкъ пюанрш я аюгни тнпслю
Class DBSQL_forum
{

   function DBSQL_forum($DBName_forum)
   {
      global $DBHost,$DBUser_forum,$DBPassword_forum;
      $conn=@mysql_connect($DBHost,$DBUser_forum,$DBPassword_forum);
	  @mysql_select_db($DBName_forum,$conn);
	  $this->CONN = $conn;
      return true;
   }
